...
export default function TopicPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-5 animate-fade-in">
      ...
      <div className="card">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="text-right flex-shrink-0">
            <div className="text-2xl font-bold text-blue-500 dark:text-blue-400">{pct}%</div>
      ...
      {/* Filters */}
      <div className="flex flex-wrap gap-2">
        <div className="flex-1 min-w-[200px] flex items-center gap-2 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded-lg px-3 py-2">
      ...
      <div className="space-y-3">
        {questions.length === 0 ? (
          <div className="text-center py-12 text-gray-500 dark:text-gray-600">No questions match your filter.</div>
        ) : (
          questions.map(q => (
